...
CREATE TABLE "competition_scoring_criteria" (
  "id" INTEGER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
  "competition_id" integer,
  "criteria_id" integer
);

CREATE TABLE "criteria_dependency" (
  "id" INTEGER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
  "criteria_id" integer,
...
COMMENT ON COLUMN "competitor"."alias" IS 'For anonymose alias';
...
ALTER TABLE "competition" ADD FOREIGN KEY ("organizer_id") REFERENCES "user" ("id");
...
ALTER TABLE "competition_scoring_criteria" ADD FOREIGN KEY ("criteria_id") REFERENCES "scoring_criteria" ("id");

ALTER TABLE "competition_scoring_criteria" ADD FOREIGN KEY ("competition_id") REFERENCES "competition" ("id");

ALTER TABLE "criteria_dependency" ADD FOREIGN KEY ("criteria_id") REFERENCES "scoring_criteria" ("id");

ALTER TABLE "criteria_dependency" ADD FOREIGN KEY ("dependent_on_criteria_id") REFERENCES "scoring_criteria" ("id");
